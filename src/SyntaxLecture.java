...
public class SyntaxLecture {
    ...
    public static void main(String[] args) {
        ...
        // Statements may be...
        // Declarations (not initialized yet)
//                 int x;
...
//                 This is valid, but not recommended. Do them separately!
//                 int y = 4, z = 5;

        // Any use of ++ or --
//                 x++;
//                 --x;
//        Don't do this! Keep these increments or decrements separate from the sout
...
//                 SomeObject = new SomeObject();
        ...
        /**
         * Comment block, use the two stars
         */
