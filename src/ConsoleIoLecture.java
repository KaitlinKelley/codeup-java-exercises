...
//        System.out.printf("Hello %S%n", name); //Capitalizes the name
        ...
        //All the words right next to each other
...
//        int five = 5;
//        String typeOfPet = "cats";
//        String catPersonality = "annoying";
//        int bill = 123789;
//
//        System.out.printf("I have %d %s %s and their vet bill was $%d", five, catPersonality, typeOfPet, bill);
